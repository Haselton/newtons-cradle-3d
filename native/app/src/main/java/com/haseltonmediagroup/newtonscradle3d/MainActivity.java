...
public class MainActivity extends AndroidApplication implements NewtonsCradleGame.PlatformBridge {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameView = initializeForView(new NewtonsCradleGame(this), cfg);
    ...
    private void loadBanner() {
        ...
        AdSize size = AdSize.getCurrentOrientationAnchoredAdaptiveBannerAdSize(this, widthDp);
        adView.setAdSize(size);
        int height = size.getHeightInPixels(this);
        FrameLayout.LayoutParams slotParams = (FrameLayout.LayoutParams) adContainer.getLayoutParams();
        slotParams.height = height;
        adContainer.setLayoutParams(slotParams);
        FrameLayout.LayoutParams gameParams = (FrameLayout.LayoutParams) gameView.getLayoutParams();
        gameParams.bottomMargin = height;
        gameView.setLayoutParams(gameParams);
        FrameLayout.LayoutParams privacyParams = (FrameLayout.LayoutParams) privacyButton.getLayoutParams();
        privacyParams.bottomMargin = height + dp(2);
